# 안녕하세요. 질문하며 배우고 시야를 넓혀가고 있는 박지수입니다 👋
...
AI 기술을 서비스에 접목한 개인 프로젝트도 진행할 예정입니다.
...
업무 이메일의 분류와 처리를 지원하는 AI 기반 졸업 프로젝트입니다.  
🎓 **졸업작품 인증**
...
서비스는 사용자와 관리자 두 가지 Role로 구성되며, **사용자 영역**을 담당했습니다.

**담당 업무**
- React 기반 사용자 프론트엔드 개발
